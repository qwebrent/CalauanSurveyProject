...
<form method="POST" action="{{ route('relative.update', $resident->id) }}" autocomplete="off" enctype="multipart/form-data">
    @method('PUT')
    @csrf   
                    ...
                    <div class="card-body">
                        <div class="pl-lg-0">
                            ...
                            <div class="row relative">
                                @foreach ($resident->relatives as $relative)
                                    <div class="form-goup d-flex align-items-center w-100">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-name">Full Name</label>
                                                <input type="text" name="full_name[]" id="input-name" class="form-control form-control-alternative" placeholder="Full Name" value="{{ $relative->full_name }}" required autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="birthday[]" id="input-name" class="form-control form-control-alternative" placeholder="Birthdate" value="{{ $relative->birthday }}" required autofocus>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="relationship[]" id="input-name" class="form-control form-control-alternative" placeholder="Relationship" value="{{ $relative->relationship }}" required autofocus>
                                            </div>
                                        </div>
